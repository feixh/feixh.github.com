...
% Image based localization for drift-free navigation and map building. Efficient algorithms for both long-term loop closure detection (visual place recognition) and short-term metric localization.
% 
...
Conducting research activities under the supervision of Prof. S. Soatto. Main projects include: visual place recognition, fast image based re-localization and visual-inertial sensor fusion for navigation, semantic mapping \& object detection.

\textsc{Zhejiang University, China}\hfill Fall 2013-Spring 2014\\
\textbf{Undergraduate Thesis}\\
Developed a Structure from Motion system for panoramic images captured by a camera mounted on a vehicle where scale, orientation and planar motion constraints are explored to improve wide-baseline feature matching.
...
\textbf{[2]} X. Fei, S. Soatto. Visual-Inertial Object Detection and Mapping. To appear ECCV, 2018.\\
...
% \textbf{Fall 2013:} Teaching Assistant \textit{Spectral Analysis of Signals}, ZJU. Instructor: Prof. X. Gong
% \hrule
%
...
% Compute Vision: Zhiyu Xiang
% Spectral Analysis of Signals: Xiaonyi Gong
% Information Theory: Zhaoyang Zhang
% Mathematical Modeling: Qifan Yang
% \\\hrule

% \section{\textsc{Relevant\\Skills}}
% \textbf{Programming Language:} C/C++, \textsc{Matlab}, Python, AndroidOS, Verilog HDL\\
% \textbf{Software Frameworks:} ROS, OpenCV, g2o, Ceres-Solver, PyTorch
